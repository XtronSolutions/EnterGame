...
var GamePlayReferenceManager = cc.Class({
  ...
  Get_GameManager: function () {
    ...
    if (this.GameMangerRef != undefined && this.GameMangerRef != null) return (this.GameMangerRef = this.GameMangerRef.getComponent("GameManager"));
    else return null;
  },
  ...
  Get_SpaceManager: function () {
    ...
    if (this.SpaceManagerRef != undefined && this.SpaceManagerRef != null) return (this.SpaceManagerRef = this.SpaceManagerRef.getComponent("SpacesManager"));
    else return null;
  },
  ...
  Get_GameplayUIManager: function () {
    ...
    if (this.GameplayUIManagerRef != undefined && this.GameplayUIManagerRef != null) return (this.GameplayUIManagerRef = this.GameplayUIManagerRef.getComponent("GameplayUIManager"));
    else return null;
  },
  ...
  Get_UIManager: function () {
    ...
    if (this.UIManagerRef != undefined && this.UIManagerRef != null) return (this.UIManagerRef = this.UIManagerRef.getComponent("UIManager"));
    else return null;
  },
  ...
  Get_MultiplayerController: function () {
    ...
    if (this.MultiplayerControllerRef != undefined && this.MultiplayerControllerRef != null) return (this.MultiplayerControllerRef = this.MultiplayerControllerRef.getComponent("MultiplayerController"));
    else return null;
  },
  ...
  Get_MultiplayerSyncManager: function () {
    ...
    if (this.MultiplayerSyncManagerRef != undefined && this.MultiplayerSyncManagerRef != null) return (this.MultiplayerSyncManagerRef = this.MultiplayerSyncManagerRef.getComponent("MultiplayerSyncManager"));
    else return null;
  },
  ...
  Get_ServerBackend: function () {
    ...
    if (this.ServerBackendRef != undefined && this.ServerBackendRef != null) return (this.ServerBackendRef = this.ServerBackendRef.getComponent("ServerBackend"));
    else return null;
  },
  ...
  Get_DecksData: function () {
    ...
    if (this.DecksDataRef != undefined && this.DecksDataRef != null) return (this.DecksDataRef = this.DecksDataRef.getComponent("DecksData"));
    else return null;
  },

  Get_QuestionsData: function () {
    if (this.QuestionsDataRef == undefined || this.QuestionsDataRef == null) this.QuestionsDataRef = cc.find("Managers/RandomQuestionsData");

    if (this.QuestionsDataRef != undefined && this.QuestionsDataRef != null) return (this.QuestionsDataRef = this.QuestionsDataRef.getComponent("QuestionsData"));
    else return null;
  },
});
