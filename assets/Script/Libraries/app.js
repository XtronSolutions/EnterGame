...
/// <reference path="Photon-Javascript_SDK.js"/>
var __extends =
  (this && this.__extends) ||
  (function () {
    var extendStatics =
...
var DemoLoadBalancing = /** @class */ (function (_super) {
  ...
  function DemoLoadBalancing() {
    DemoWss = AppInfo.Wss;
    DemoAppId = AppInfo && AppInfo.AppId ? AppInfo.AppId : "<no-app-id>";
    DemoAppVersion = AppInfo && AppInfo.AppVersion ? AppInfo.AppVersion : "1.0";
    DemoMasterServer = AppInfo.MasterServer;
    DemoFbAppId = AppInfo.FbAppId;

    console.log("initializes: " + DemoAppId + " " + AppInfo.AppId);
  ...
  DemoLoadBalancing.prototype.onEvent = function (code, content, actorNr) {
    switch (code) {
      case 1:
        ...
        if (actorNr) this.output(sender + ": " + mess, this.myRoomActors()[actorNr].getCustomProperty("color"));
